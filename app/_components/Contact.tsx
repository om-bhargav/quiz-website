      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-block bg-background neo-border neo-shadow px-6 py-2 mb-6">
            <span className="font-bold uppercase tracking-widest text-foreground">Contact Us</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
            Got Questions?{" "}
            <span className="bg-neo-yellow neo-border px-2">Let's Talk! 💬</span>
          </h2>
          <p className="text-lg text-foreground/80 max-w-xl mx-auto">
            Reach out to us anytime — we'd love to hear from you. Drop a message on WhatsApp or fill out the form below.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="neo-card bg-background p-8">
            ...
            <form className="space-y-4">
              <div>
                <label className="block font-bold text-foreground mb-1 text-sm uppercase tracking-wide">Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-bold text-foreground mb-1 text-sm uppercase tracking-wide">Email</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block font-bold text-foreground mb-1 text-sm uppercase tracking-wide">Message</label>
                <textarea
                  rows={4}
              ...
              <button type="submit" className="neo-btn bg-neo-pink text-primary-foreground w-full text-center">
                Send Message 🚀
              </button>
            </form>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              <div>
                <h3 className="text-2xl font-bold text-foreground mb-1">Chat on WhatsApp</h3>

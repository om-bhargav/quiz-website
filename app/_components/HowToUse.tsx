...
const steps = [
  {
    ...
    description:
      "Install " +
      SITE_NAME +
      " from the Play Store and create your free account. Instantly get 100 bonus tokens!",
    bg: "bg-neo-yellow",
  },
  {
    step: "02",
    ...
    title: "Choose & Play",
    description:
      "Browse quiz categories — from Science to Bollywood. Use tokens to enter a game and start answering!",
    bg: "bg-neo-blue",
  },
  {
    step: "03",
    ...
    title: "Win & Withdraw",
    description:
      "Answer correctly to win prize money. Withdraw your earnings directly to your bank account instantly!",
    bg: "bg-neo-pink",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-4">
            3 Simple Steps to{" "}
            <span className="bg-background neo-border px-2">
              Start Winning 💰
            </span>
          </h2>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-4">
          {steps.map((step, i) => (
            <div
              key={i}
              className="flex flex-col lg:flex-row items-center gap-4 lg:gap-4 w-full lg:w-auto"
            >
              <div
                className={`neo-card-hover p-8 ${step.bg} flex-1 w-full lg:max-w-sm`}
              >
